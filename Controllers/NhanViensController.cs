...
namespace thi1.Controllers
{
    public class NhanViensController : Controller
    {
        ...
        public PartialViewResult catoMenu()
        {
            var result=db.Phongs.ToList();
            return PartialView(result);
        }
        [Route("nhanViens/nhanvienbyphong/{depid}")]
        public ActionResult DisLaynvbyphong(int depid)
        {
            var result=db.NhanViens.Where(e=>e.Maphong==depid).ToList();
            return View(result);
        }
